...
| [CloudWatch alarms for EC2 CPU usage](https://github.com/jayshun2/PRJ008-ec2-cloudwatch-cpu) | This project sets up a CloudWatch alarm to monitor EC2 CPU usage and send notifications when performance crosses a defined threshold. | CloudWatch, EC2, SNS | Completed |
| [Tracking API activity on account with CloudTrail](https://github.com/jayshun2/PRJ009-Cloudtrail-API-activity) | A simple AWS project that uses CloudTrail to record and analyze API activity for visibility and security in your account. | AWS CLI, CloudTrail, Athena | Completed |
